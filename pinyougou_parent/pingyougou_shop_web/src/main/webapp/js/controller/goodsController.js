//控制层
app.controller('goodsController', function ($scope, $controller, typeTemplateService,$location, uploadService, itemCatService, goodsService) {
    ...
    $scope.findOne = function (id) {
        ...
        goodsService.findOne(id).success(
            function (response) {
                ...
                // 显示图片列表 由于数据库查出来的是字符串，需要解析出json对象
